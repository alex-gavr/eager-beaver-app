...
export const TwoColumnsNoAni = ({ images, alt, imageSide, heading, paragraph }: IProps) => {
  ...
  return (
    <div className='grid min-h-[25rem] grid-cols-1 items-center justify-center gap-12 gap-x-4 rounded-3xl lg:grid-cols-2'>
      <div
        className={cn(
      ...
      >
        <h2 className='rounded-3xl bg-primary-800 px-4 py-2 text-center text-xl uppercase tracking-wider dark:bg-primary-800 dark:text-slate-950 md:text-2xl lg:text-3xl'>
          {heading}
        </h2>
...
export default TwoColumnsNoAni;
