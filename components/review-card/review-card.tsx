      ...
      <StyledCard>
        ...
        <StyledReviewCard onClick={toggleClassName}>
          <ParentsInfoContainer>
            <ParentName>
              {' '}
              {isImgLoaded ? parent : <Skeleton height={15} width={width < 500 ? 100 : 200} />}
            </ParentName>
            <p>
              {isImgLoaded ? `${relationToChild}:` : <Skeleton height={15} width={width < 500 ? 100 : 200} />}
            </p>
          </ParentsInfoContainer>
          <StyledReviewText ref={ref} $showFullText={showFullText}>
            {isImgLoaded ? (
              ...
              <Skeleton
                height={15}
                width={width < 500 ? 300 : width < 1000 ? 350 : width < 1200 ? 450 : 550}
                count={4}
              />
            )}
          </StyledReviewText>
